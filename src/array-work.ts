...
let catalogueOFMUrkPublication:  string[] = [
...
// push command
catalogueOFMUrkPublication.push(
  "A grammar of society and politics (Criticism):"
);
...
let priceList: number[] = [200, 400, 200, 1000, 1000, 700, 200, 700, 500];
...
let multiplySign: string = "x 10 copies =" // we use this code for multiply sign.  
let multiplication = priceList[8] * 10; // we use this code for multiplication price.
let numberOfCopies: string = "copies" // we use this code for number of copies.  
...
// define our tuple
let Quiz: [number, string, boolean];
...
// Readonly tuple
let Quiz1: readonly [number, string, boolean];
// initialize correctly
